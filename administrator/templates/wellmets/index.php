...
<head>
	...
	<style type="text/css">
		.header
		{
			...
			background: -moz-linear-gradient(top,<?php echo $this->params->get('headerColor'); ?> 0%,#ededed 100%);
			background: -webkit-gradient(linear,left top,left bottom,color-stop(0%,<?php echo $this->params->get('headerColor'); ?>),color-stop(100%,#ededed));
			background: -webkit-linear-gradient(top,<?php echo $this->params->get('headerColor'); ?> 0%,#ededed 100%);
			background: -o-linear-gradient(top,<?php echo $this->params->get('headerColor'); ?> 0%,#ededed 100%);
			background: -ms-linear-gradient(top,<?php echo $this->params->get('headerColor'); ?> 0%,#ededed 100%);
			background: linear-gradient(top,<?php echo $this->params->get('headerColor'); ?> 0%,#ededed 100%);
			filter: progid:DXImageTransform.Microsoft.gradient(startColorstr='<?php echo $this->params->get('headerColor'); ?>',endColorstr='#ededed',GradientType=0);
...
<body class="admin ng-cloak <?php echo $option . " view-" . $view . " layout-" . $layout . " task-" . $task . " itemid-" . $itemid . " "; ?>" <?php if ($stickyToolbar) : ?>data-spy="scroll" data-target=".subhead" data-offset="87"<?php endif; ?> ng-app="phonecatApp">
	<!-- Top Navigation -->
		...
		<div class="container-fluid">
			<div class="row-fluid">
				<div class="span2 container-logo">
					<a class="logo" href="<?php echo $this->baseurl."/index.php?option=com_mets"; ?>"><img src="<?php echo $logo; ?>" alt="<?php echo $sitename; ?>" /></a>
				</div>
				<div class="span10">

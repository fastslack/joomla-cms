 ...
 * @since       1.0
 */
abstract class JOauth2CredentialsState
{
	/**
	 * @var    JOauth2TableCredentials  Table object for credentials.
	 * @since  1.0
	 */
	protected $table;
	 ...
	 * Object constructor.
	 *
	 * @param   JOauth2TableCredentials  $table       The database driver to use when persisting the object.
	 * @param   array                    $properties  A set of properties with which to prime the object.
	 *
	 * @codeCoverageIgnore
	 * @since   1.0
	 */
	public function __construct(JOauth2TableCredentials $table = null, array $properties = null)
	{
		// Setup the table object.
		$this->table = $table ? $table : JTable::getInstance('Credentials', 'JOauth2Table');

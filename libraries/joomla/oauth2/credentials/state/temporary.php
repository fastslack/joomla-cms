 ...
 * @since       1.0
 */
class JOauth2CredentialsStateTemporary extends JOauth2CredentialsState
{
	/**
	...
	public function authorise($resourceOwnerId, $lifetime = 'PT1H')
	{
		...
		$this->table->type = JOauth2Credentials::AUTHORISED;
		...
		$authorised = new JOauth2CredentialsStateAuthorised($this->table);
	...
	public function deny()
	{
		...
		return new JOauth2CredentialsStateDenied($this->table);
	}

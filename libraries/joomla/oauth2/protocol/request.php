...
class JOauth2ProtocolRequest
{
	 ...
	 * @since   1.0
	 */
	public function __construct(JOauth2TableCredentials $table = null)
	{
		...
		$this->_response = new JOauth2ProtocolResponse;
	}
	...
	public function fetchMessageFromRequest()
	{
		...
		// Loading the response class
		$requestHeader = new JOauth2ProtocolRequestHeader;
		...
		$class = "JOauth2ProtocolRequest" . ucfirst($method);
